#!/bin/bash
# filepath: setup_server_kernel.sh
...
echo ""
echo "File descriptor and process limits (will take effect after reboot/relogin):"
cat /etc/security/limits.conf | grep -E "(nofile|nproc)" | grep -v "^#"

echo ""
echo "==================================="
echo " Server VM setup complete!"
echo "==================================="
echo ""
